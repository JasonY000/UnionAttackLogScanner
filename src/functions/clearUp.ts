...
// export function clearUp(text: string): any[] {
//   console.log('running clearUp');
//   //console.log(text);
//   let regex: RegExp = /[@]+/gm;
...
//   const textArr: any[] = text.replaceAll('\n', '@').toLowerCase().split(regex);
...
//   let filterReg2: RegExp = /[.\\]+/g;
//   // used to turn string number with , into floats
//   let filterReg4: RegExp = /[,]/g;
//   textArr.forEach((element: string, i?: number) => {
